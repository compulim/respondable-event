...
- 👷🏻 Test framework moved to Node.js test runner, by [@compulim](https://github.com/compulim) in PR [#13](https://github.com/compulim/respondable-event/pull/13)

## [0.1.1] - 2025-12-23

### Changed

- Bumped dependencies, in PR [#10](https://github.com/compulim/respondable-event/pull/10)
  - Development dependencies
    - [`@babel/core@7.28.5`](https://npmjs.com/package/@babel/core/v/7.28.5)
    ...
    - [`@types/selenium-webdriver@4.35.4`](https://npmjs.com/package/@types/selenium-webdriver/v/4.35.4)
    ...
    - [`babel-jest@30.2.0`](https://npmjs.com/package/babel-jest/v/30.2.0)
    ...
    - [`nodemon@3.1.11`](https://npmjs.com/package/nodemon/v/3.1.11)
    ...
    - [`selenium-webdriver@4.39.0`](https://npmjs.com/package/selenium-webdriver/v/4.39.0)
...
[Unreleased]: https://github.com/compulim/respondable-event/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/compulim/respondable-event/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/compulim/respondable-event/releases/tag/v0.1.0
